        ...
        <div className="container about-layout">
          <div className="about-media" data-reveal>
            <div className="about-media-main">
              <Image
                ...
                alt={t(
                  {
                    fa: "پرتره داکتر محب الله احمدزی",
                    en: "Portrait of Dr. Mohibullah Ahmadzai",
                    ps: "د ډاکټر محب الله احمدزی انځور",
                  },
                  locale,
                )}
                fill
          ...
          <div className="about-copy" data-reveal>
            ...
            <div style={{ marginTop: "1.5rem" }}>
              <Link
                href={`/${locale}/doctor/${DOCTOR_SLUG}`}
                className="button button-secondary"
                style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem" }}
              >
                {t(pageCopy.viewProfile, locale)}
                <ArrowLeftIcon />
              </Link>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="services-layout" data-reveal>
            ...
            <div className="services-visual glass-card">
              {(() => {
                const clinicImages = heroImagesByKey?.clinic || [];
